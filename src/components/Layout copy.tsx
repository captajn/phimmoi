...
export function Layout({ children }: LayoutProps) {
  ...
  useEffect(() => {
    // Focus vào ô tìm kiếm khi kích hoạt
  ...
  const renderDropdown = (label: string, items: { name: string; slug: string }[], basePath: string) => (
    <div className="relative group py-2 flex justify-center text-center">
      <button className="text-white hover:text-yellow-400 text-base font-semibold shadow-text whitespace-nowrap">
        {label}
        <span className="ml-1">▾</span>
      </button>
      <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 mt-2 header-dropdown rounded-md shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <header className="fixed top-0 left-0 right-0 w-full z-[9999]">
        <div className="bg-gradient-to-b from-black/90 via-black/70 to-black/0 backdrop-blur-sm">
            ...
            <div className="flex items-center h-20">
              <div className="grid grid-cols-3 items-center w-full md:flex md:w-auto">
                ...
                <div className="flex justify-center md:justify-start">
                  <Link href="/" className="flex items-center md:mr-3 lg:mr-6">
                    <Image 
                      src="/images/logo.png"
                      alt="PhimMoi Logo"
                      width={120}
              ...
              {/* Desktop Search Form */}
              <div className="hidden md:block md:flex-shrink-0 md:ml-1 md:mr-2 lg:mr-6">
              ...
              {/* Desktop Navigation */}
              <nav className="hidden md:flex md:flex-grow items-center justify-evenly md:space-x-2 lg:space-x-10 transparent-header">
          ...
          <div className="absolute top-0 left-0 h-full w-[85%] max-w-[320px] bg-[#1a1b1d] shadow-xl z-10 overflow-y-auto">
            <div className="p-5">
              ...
              <div className="space-y-3 text-white">
                {/* Duyệt tìm - Không phải dropdown nữa */}
